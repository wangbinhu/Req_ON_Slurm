...
cat    $Main_Script_DIR/sh.config    $Main_Script_DIR/gatk.shell/s02.bam.to.gvcf.with.bed/tmp.s03.step01.bam.to.gvcf.sh    >    $S03_Step01_OU_PATH/s03.step01.bam.to.gvcf.sh ;
cat    $Main_Script_DIR/py.config    $Main_Script_DIR/gatk.shell/s02.bam.to.gvcf.with.bed/tmp.s03.step01.bam.to.gvcf.py    >    $S03_Step01_OU_PATH/s03.step01.bam.to.gvcf.py ;
# bam.to.gvcf.add:
cat    $Main_Script_DIR/py.config    $Main_Script_DIR/gatk.shell/s02.bam.to.gvcf.with.bed/tmp.s03.step01.bam.to.gvcf.apy    >    $S03_Step01_OU_PATH/s03.step01.bam.to.gvcf.apy ;
...
cat    $Main_Script_DIR/py.config    $Main_Script_DIR/gatk.shell/s02.bam.to.gvcf.with.bed/tmp.s03.step02.gvcf.to.chr.gvcf.py    >    $S03_Step02_OU_PATH/s03.step02.gvcf.to.chr.gvcf.py ;
