...
# s01.step02:
S01_Step02_Filter_Log_DIR = '/ifswh1/BC_COM_P4/F21FTSSCKF9402/SUSnrzjR/02.process/l01.log'    # fix
s01_Step02_Tmp_Shell= '/ifswh1/BC_COM_P4/F21FTSSCKF9402/SUSnrzjR/02.process/s02.soapnuke.fliter.sh'   # fix: raw data path

# ------------------------------------------------------------------------------------------------------------------------------ S01  filter clean  data:


# ------------------------------------------------------------------------------------------------------------------------------ S01  filter clean  data:
BAM_Dir='$Main_WK_DIR/02.bwa'                         # fix
BWA_Job_name = 'B12'
# ------------------------------------------------------------------------------------------------------------------------------ S01  filter clean  data:
