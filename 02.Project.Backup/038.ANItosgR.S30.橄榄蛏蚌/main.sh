...
cat    $Main_Script_DIR/00.Bin.Cofigure.Start/sh.config    $Main_Script_DIR/01.Temp.Configure/bwa.shell/tmp.s02.step01.clean.to.rmdup.bam.sh    >    $Main_WK_DIR/02.bwa/s02.step01.clean.to.rmdup.bam.sh;
cat    $Main_Script_DIR/00.Bin.Cofigure.Start/py.config    $Main_Script_DIR/01.Temp.Configure/bwa.shell/tmp.s02.step01.clean.to.rmdup.bam.py      >    $Main_WK_DIR/02.bwa/s02.step01.clean.to.rmdup.bam.py;
# ------------------------------------------------------------------------------------------------------------------------------ S02 clean to bam
...
cat    $Main_Script_DIR/00.Bin.Cofigure.Start/sh.config    $Main_Script_DIR/01.Temp.Configure/gatk.shell/s02.bam.to.gvcf.with.bed/tmp.s03.step04.bed.gvcf.to.genome.gvcf.sh    >    $S03_Step04_OU_PATH/s03.step04.bed.gvcf.to.genome.gvcf.sh ;
cat    $Main_Script_DIR/00.Bin.Cofigure.Start/py.config    $Main_Script_DIR/01.Temp.Configure/gatk.shell/s02.bam.to.gvcf.with.bed/tmp.s03.step04.bed.gvcf.to.genome.gvcf.py    >    $S03_Step04_OU_PATH/s03.step04.bed.gvcf.to.genome.gvcf.py ;
# ------------------------------------------------------------------------------------------------------------------------------ S03 bam to gvcf
...
cat    $Main_Script_DIR/00.Bin.Cofigure.Start/sh.config    $Main_Script_DIR/01.Temp.Configure/S06.SV/S06.step01.bam.to.sv/tmp.s06.step01.bam.to.sv.sh     >    $S06_Step01_OU_PATH/s06.step01.bam.to.sv.sh ;
...
cat    $Main_Script_DIR/00.Bin.Cofigure.Start/sh.config    $Main_Script_DIR/01.Temp.Configure/S06.SV/S06.step02.sv.merge.and.ano/tmp.s06.step02.merge.sv.and.ano.sh     >    $S06_Step02_OU_PATH/s06.step02.merge.sv.and.ano.sh ;
...
cat    $Main_Script_DIR/00.Bin.Cofigure.Start/sh.config    $Main_Script_DIR/01.Temp.Configure/S07.CNV/S07.step01.bam.to.cnv/tmp.s07.step01.bam.to.cnv.sh     >    $S07_Step01_OU_PATH/s07.step01.bam.to.cnv.sh ;
...
cat    $Main_Script_DIR/00.Bin.Cofigure.Start/sh.config    $Main_Script_DIR/01.Temp.Configure/S07.CNV/S07.step02.cnv.merge.and.ano/tmp.s07.step02.merge.cnv.and.ano.sh     >    $S07_Step02_OU_PATH/s07.step02.merge.cnv.and.ano.sh ;
